...
class DynamicsCellsViewController: DynamicActionSheet {
    ...
    @IBAction func add3() {
        DynamicCellController.sharedInstance.postCell(self, key: "ConnectPodToModemCell", leadingActions: "Hello", trailingActions: "Delete".localize(), once: false, only: false, tableViewScrollToBottom: true)
    }
